...
from PGKD_Net.Detrans.ops.ms_deform_attn_func import ms_deform_attn_core_pytorch_2D
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index,
        ...
        if reference_points.shape[-1] == 3:
            offset_normalizer = torch.stack(
                [input_spatial_shapes[..., 0], input_spatial_shapes[..., 2], input_spatial_shapes[..., 1]], -1)
        ...
        output = ms_deform_attn_core_pytorch_2D(value, input_spatial_shapes, sampling_locations, attention_weights)
